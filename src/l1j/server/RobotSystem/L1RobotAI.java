...
public class L1RobotAI {
	...
	if (robot.hasSkillEffect(L1SkillId.SHOCK_STUN) || robot.hasSkillEffect(L1SkillId.ICE_LANCE)
		|| robot.hasSkillEffect(L1SkillId.BONE_BREAK) || robot.hasSkillEffect(L1SkillId.EARTH_BIND)
		|| robot.hasSkillEffect(L1SkillId.MOB_RANGESTUN_19) || robot.hasSkillEffect(L1SkillId.MOB_SHOCKSTUN_30)
		|| robot.hasSkillEffect(L1SkillId.OMAN_STUN) || robot.hasSkillEffect(L1SkillId.ANTA_MESSAGE_6)
		|| robot.hasSkillEffect(L1SkillId.ANTA_MESSAGE_7) || robot.hasSkillEffect(L1SkillId.MOB_COCA)
	...
	// - 追加のソース
	interval = SprTable.getInstance().getAttackSpeed(robot.getTempCharGfx(), robot.getCurrentWeapon() + 1,
		robot.getLevel(), robot.getClassId());
	...
	try {
		...
		switch (buff_step++) {
		case 0:
		    skillId = L1SkillId.REDUCTION_ARMOR;
		    break;
		case 1:
		    skillId = L1SkillId.SOLID_CARRIAGE;
		    break;
		case 2:
		...
		switch (buff_step++) {
		case 0:
		    skillId = L1SkillId.STORM_SHOT;
		    break;
		case 1:
		    skillId = L1SkillId.RESIST_MAGIC;
		    break;
		case 2:
		    skillId = L1SkillId.CLEAR_MIND;
		    break;
		case 3:
		    skillId = L1SkillId.RESIST_ELEMENTAL;
		    break;
		case 4:
		...
		case 5:
		    ...
		    break;
		case 6:
		    skillId = L1SkillId.PHYSICAL_ENCHANT_DEX;
		    break;
		case 7:
		    skillId = L1SkillId.PHYSICAL_ENCHANT_STR;
		    break;
		case 8:
		    skillId = L1SkillId.BLESS_WEAPON;
		    break;
		case 9:
		    skillId = L1SkillId.COUNTER_MAGIC;
		    break;
		default:
		    buff_step = 0;
		    return;
		...
		switch (buff_step++) {
		case 0:
		    skillId = L1SkillId.ADVANCE_SPIRIT;
		    break;
		case 1:
		    skillId = L1SkillId.PHYSICAL_ENCHANT_DEX;
		    break;
		case 2:
		    ...
		    break;
		case 3:
		    skillId = L1SkillId.BERSERKERS;
		    break;
		case 4:
		    skillId = L1SkillId.HOLY_WALK;
		    break;
		case 5:
		    skillId = L1SkillId.BLESS_WEAPON;
		    break;
		case 6:
		    ...
		    break;
		case 7:
		    skillId = L1SkillId.IMMUNE_TO_HARM;
		    break;
		default:
		    buff_step = 0;
		    return;
		...
		switch (buff_step++) {
		case 0:
		    skillId = L1SkillId.ENCHANT_VENOM;
		    break;
		case 1:
		    skillId = L1SkillId.SHADOW_ARMOR;
		    break;
		case 2:
		    skillId = L1SkillId.DOUBLE_BRAKE;
		    break;
		case 3:
		    skillId = L1SkillId.UNCANNY_DODGE;
		    break;
		case 4:
		    skillId = L1SkillId.DRESS_DEXTERITY;
		    break;
		case 5:
		    skillId = L1SkillId.DRESS_MIGHTY;
		    break;
		case 6:
		    skillId = L1SkillId.MOVING_ACCELERATION;
		    break;
		case 7:
		    skillId = L1SkillId.VENOM_RESIST;
		    break;
		case 8:
		    skillId = L1SkillId.BURNING_SPIRIT;
		    break;
		case 9:
		    skillId = L1SkillId.DRESS_EVASION;
		    break;
		case 10:
		    skillId = L1SkillId.BLAZING_SPIRITS;
		    break;
		default:
		    buff_step = 0;
		    return;
		...
		case 0:
		    ...
		    break;
		case 1:
		    skillId = L1SkillId.BLOOD_LUST;
		    break;
		case 2:
		    skillId = L1SkillId.MORTAL_BODY;
		    break;
		case 3:
		    skillId = L1SkillId.SCALES_FIRE_DRAGON;
		    break;
		default:
		    buff_step = 0;
		    return;
		...
		switch (buff_step++) {
		case 0:
		    skillId = L1SkillId.MIRROR_IMAGE;
		    break;
		case 1:
		    skillId = L1SkillId.IllUSION_OGRE;
		    break;
		case 2:
		    skillId = L1SkillId.CONCENTRATION;
		    break;
		case 3:
		    skillId = L1SkillId.IllUSION_LICH;
		    break;
		case 4:
		    skillId = L1SkillId.PATIENCE;
		    break;
		case 5:
		    skillId = L1SkillId.IllUSION_DIAMONDGOLEM;
		    break;
		case 6:
		    skillId = L1SkillId.INSIGHT;
		    break;
		case 7:
		    skillId = L1SkillId.IMPACT;
		    break;
		default:
		    buff_step = 0;
		    return;
	    ...
	    if (robot.hasSkillEffect(skillId)) {
		return;
	    }
	    Broadcaster.broadcastPacket(robot, new S_DoActionGFX(robot.getId(), 19));
	    new L1SkillUse().handleCommands(robot, skillId, robot.getId(), robot.getX(), robot.getY(), null, 0,
	...
	try {
	    if (isDistance(robot.getX(), robot.getY(), robot.getMapId(), target.getX(), target.getY(),
		    target.getMapId(), robot.isElf() ? 8 : 1)) {
	...
	try {
	    ...
	    // ウォーキング
	    if (type != 1 && target != null && !(target instanceof L1PcInstance)
		    && !(target instanceof L1GuardianInstance) && ((L1MonsterInstance) target).getHiddenStatus() >= 1) {
		attackList.remove(target);
		target = null;
		return;
	    }
	    ...
	    // オブジェクトの距離を確認し
	    if (type > 1 && isDistance(robot.getX(), robot.getY(), robot.getMapId(), target.getX(), target.getY(),
		    target.getMapId(), robot.isElf() ? 8 : 1)) {
		// ユーザーは区分処理します。
		if (target instanceof L1PcInstance) { // PCラング戦っ場合。
		    // ウィザード
		    if (robot.isWizard() && robot.getCurrentMp() >= 50
			    && isDistance(robot.getX(), robot.getY(), robot.getMapId(), target.getX(), target.getY(),
				    target.getMapId(), robot.isWizard() ? 5 : 1)) {
			if (target.hasSkillEffect(L1SkillId.SILENCE) || target.hasSkillEffect(L1SkillId.DECAY_POTION)
				|| target.hasSkillEffect(L1SkillId.SHOCK_STUN)
				|| target.hasSkillEffect(L1SkillId.THUNDER_GRAB)
				|| target.hasSkillEffect(L1SkillId.MIND_BREAK) || target.hasSkillEffect(L1SkillId.PANIC)
			...
			// ナイト
		    } else if (robot.isKnight() && robot.getCurrentMp() >= 50
			    && isDistance(robot.getX(), robot.getY(), robot.getMapId(), target.getX(), target.getY(),
				    target.getMapId(), robot.isKnight() ? 2 : 1)) {
			if (target.hasSkillEffect(L1SkillId.SILENCE) || target.hasSkillEffect(L1SkillId.DECAY_POTION)
				|| target.hasSkillEffect(L1SkillId.SHOCK_STUN)
				|| target.hasSkillEffect(L1SkillId.THUNDER_GRAB)
				|| target.hasSkillEffect(L1SkillId.MIND_BREAK) || target.hasSkillEffect(L1SkillId.PANIC)
			...
			// 竜騎士
		    } else if (robot.isDragonknight() && robot.getCurrentMp() >= 50
			    && isDistance(robot.getX(), robot.getY(), robot.getMapId(), target.getX(), target.getY(),
				    target.getMapId(), robot.isDragonknight() ? 2 : 1)) {
			if (target.hasSkillEffect(L1SkillId.SILENCE) || target.hasSkillEffect(L1SkillId.DECAY_POTION)
				|| target.hasSkillEffect(L1SkillId.SHOCK_STUN)
				|| target.hasSkillEffect(L1SkillId.THUNDER_GRAB)
				|| target.hasSkillEffect(L1SkillId.MIND_BREAK) || target.hasSkillEffect(L1SkillId.PANIC)
			...
			// イリュージョニスト
			    ...
			    && isDistance(robot.getX(), robot.getY(), robot.getMapId(), target.getX(), target.getY(),
				    target.getMapId(), robot.isBlackwizard() ? 4 : 1)) {
			if (target.hasSkillEffect(L1SkillId.SILENCE) || target.hasSkillEffect(L1SkillId.DECAY_POTION)
				|| target.hasSkillEffect(L1SkillId.SHOCK_STUN)
				|| target.hasSkillEffect(L1SkillId.THUNDER_GRAB)
				|| target.hasSkillEffect(L1SkillId.MIND_BREAK) || target.hasSkillEffect(L1SkillId.PANIC)
			...
			// 妖精
		    } else if (robot.isElf() && robot.getCurrentMp() >= 50 && isDistance(robot.getX(), robot.getY(),
			    robot.getMapId(), target.getX(), target.getY(), target.getMapId(), robot.isElf() ? 7 : 1)) {
			if (target.hasSkillEffect(L1SkillId.SILENCE) || target.hasSkillEffect(L1SkillId.DECAY_POTION)
				|| target.hasSkillEffect(L1SkillId.SHOCK_STUN)
				|| target.hasSkillEffect(L1SkillId.THUNDER_GRAB)
				|| target.hasSkillEffect(L1SkillId.MIND_BREAK) || target.hasSkillEffect(L1SkillId.PANIC)
	...
	if (robot.isWizard()) {
	    ...
	    switch (a) {
	    case 1:
		new L1SkillUse().handleCommands(robot, L1SkillId.SUNBURST, o.getId(), o.getX(), o.getY(), null, 0,
			L1SkillUse.TYPE_GMBUFF);
		robot.setCurrentMp(1);
		/*
		 * L1Skills skill =
		 * SkillsTable.getInstance().getTemplate(L1SkillId.SUNBURST);
		 * robot.setCurrentMp(robot.getCurrentMp()-skill.getMpConseume()
		 * );
		 */
		break;
	    case 2:
		new L1SkillUse().handleCommands(robot, L1SkillId.SILENCE, o.getId(), o.getX(), o.getY(), null, 0,
			L1SkillUse.TYPE_GMBUFF);
		robot.setCurrentMp(1);
		break;
	    case 3:
		new L1SkillUse().handleCommands(robot, L1SkillId.ERUPTION, o.getId(), o.getX(), o.getY(), null, 0,
			L1SkillUse.TYPE_GMBUFF);
		robot.setCurrentMp(1);
		break;
	    case 4:
		new L1SkillUse().handleCommands(robot, L1SkillId.DECAY_POTION, o.getId(), o.getX(), o.getY(), null, 0,
			L1SkillUse.TYPE_GMBUFF);
		robot.setCurrentMp(1);
		break;
	    case 5:
		new L1SkillUse().handleCommands(robot, L1SkillId.WEAPON_BREAK, o.getId(), o.getX(), o.getY(), null, 0,
			L1SkillUse.TYPE_GMBUFF);
		robot.setCurrentMp(1);
		break;
	...
	if (robot.isKnight()) {
	    new L1SkillUse().handleCommands(robot, L1SkillId.SHOCK_STUN, o.getId(), o.getX(), o.getY(), null, 0,
		    L1SkillUse.TYPE_GMBUFF);
	    robot.setCurrentMp(1);
	}
    }
	...
	switch (a) {
	case 1:
	    new L1SkillUse().handleCommands(robot, L1SkillId.FOU_SLAYER, o.getId(), o.getX(), o.getY(), null, 0,
		    L1SkillUse.TYPE_GMBUFF);
	    robot.setCurrentMp(1);
	    break;
	case 2:
	    new L1SkillUse().handleCommands(robot, L1SkillId.THUNDER_GRAB, o.getId(), o.getX(), o.getY(), null, 0,
		    L1SkillUse.TYPE_GMBUFF);
	    robot.setCurrentMp(1);
	    break;
	case 3:
	...
	if (robot.isBlackwizard()) {
	    ...
	    switch (a) {
	    case 1:
		new L1SkillUse().handleCommands(robot, L1SkillId.MIND_BREAK, o.getId(), o.getX(), o.getY(), null, 0,
			L1SkillUse.TYPE_GMBUFF);
		robot.setCurrentMp(1);
		break;
	    case 2:
		...
		break;
	    case 3:
		new L1SkillUse().handleCommands(robot, L1SkillId.PANIC, o.getId(), o.getX(), o.getY(), null, 0,
			L1SkillUse.TYPE_GMBUFF);
		robot.setCurrentMp(1);
		break;
	    case 4:
		new L1SkillUse().handleCommands(robot, L1SkillId.IllUSION_AVATAR, o.getId(), o.getX(), o.getY(), null,
	...
	if (robot.isElf()) {
		...
		break;
	    case 3:
		new L1SkillUse().handleCommands(robot, L1SkillId.STRIKER_GALE, o.getId(), o.getX(), o.getY(), null, 0,
			L1SkillUse.TYPE_GMBUFF);
		robot.setCurrentMp(1000);
		break;
	    case 4:
		new L1SkillUse().handleCommands(robot, L1SkillId.POLLUTE_WATER, o.getId(), o.getX(), o.getY(), null, 0,
			L1SkillUse.TYPE_GMBUFF);
		robot.setCurrentMp(1000);
		break;
	    case 5:
		...
		break;
	    case 6:
		new L1SkillUse().handleCommands(robot, L1SkillId.EARTH_BIND, o.getId(), o.getX(), o.getY(), null, 0,
			L1SkillUse.TYPE_GMBUFF);
		robot.setCurrentMp(1000);
		break;
	    default:
	...
	try {
		...
		if (oo instanceof L1PcInstance) {
		    ...
		    if (o == null) {
			o = oo;
		    } else if (!o.isDead() && getDistance(robot.getX(), robot.getY(), oo.getX(),
			    oo.getY()) < getDistance(robot.getX(), robot.getY(), o.getX(), o.getY())) {
			o = oo;
		    }
		}
	    }
	...
	// for (L1PcInstance pc2 :
	// L1World.getInstance().getVisiblePlayer(robot)) {
	...
	moveCount++;
	// System.out.println("ロボット名： "+ robot.getName（）+"状態： "+
	// getAiStatus（）+"タイプ： "+ type）;
	// System.out.println("モンスターリスト： "+
	// attackList.toHateArrayList（）。size（）+"ポーション数： "+ postionCount +"動き "+
	// moveCount）;
	if (moveCount >= 5) {
	...
	if (astar) {
		...
		toMoving(iPath[iCurrentPath][0], iPath[iCurrentPath][1],
			calcheading(robot.getX(), robot.getY(), iPath[iCurrentPath][0], iPath[iCurrentPath][1]));
	    } else {
	    }
	} else {
	    toMoving(x, y, h);
	...
	try {
		...
		if (dropItem != null && !isDistance(robot.getX(), robot.getY(), robot.getMapId(), dropItem.getX(),
			dropItem.getY(), dropItem.getMapId(), (robot.isElf() ? 8 : 1))) {

		    toMoving(dropItem, dropItem.getX(), dropItem.getY(), 0, true);

		    groundInventory = L1World.getInstance().getInventory(dropItem.getX(), dropItem.getY(),
			    dropItem.getMapId());
		...
		if (pc.getLocation().getTileLineDistance(obj.getLocation()) <= 2) {
			...
			if (object != null) {
			    ...
			    Broadcaster.broadcastPacket(pc,
				    new S_AttackPacket(pc, obj.getId(), ActionCodes.ACTION_Pickup));
			    dropItem = null;
			    groundInventory = null;
			    object = null;
			    dropCheck = false;
