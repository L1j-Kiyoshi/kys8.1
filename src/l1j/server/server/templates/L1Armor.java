...
public class L1Armor extends L1Item {
    ...
    public int getIgnoreReductionByArmor() {
        return _ignorereductionbyarmor;
    }

    public void setIgnoreReductionByArmor(int i) {
        _ignorereductionbyarmor = i;
    }
    ...
    public int get_regist_DESPERADO() {
        return this._regist_DESPERADO;
    }

    public void set_regist_DESPERADO(int i) {
        _regist_DESPERADO = i;
    }
