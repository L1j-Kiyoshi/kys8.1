...
public class GameClient {
	...
	// if (CharReStart()) {
	// if (!(opcode == Opcodes.C_ENTER_WORLD || opcode == Opcodes.S_KICK ||
	// opcode == Opcodes.C_LOGOUT
	// || opcode == Opcodes.C_VOICE_CHAT || opcode ==
	// Opcodes.C_EXTENDED_PROTOBUF // 157
	// || opcode == Opcodes.S_CREATE_CHARACTER_CHECK//
	// S_CREATE_CHARACTER_CHECK
	// || opcode == Opcodes.S_EXTENDED_PROTOBUF || opcode ==
	// Opcodes.C_CREATE_CUSTOM_CHARACTER
	// || opcode == Opcodes.C_QUIT || opcode == Opcodes.C_SHIFT_SERVER ||
	// opcode == Opcodes.C_CHANNEL // 55
	// || opcode == Opcodes.S_NUM_CHARACTER || opcode == Opcodes.C_LOGIN ||
	// opcode == Opcodes.C_READ_NEWS
