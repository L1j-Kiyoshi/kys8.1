...
/*용뼈*/			|| ((pc.getX() >= 33261 && pc.getX() <= 33266) && (pc.getY() >= 32397 && pc.getY() <= 32405) && pc.getMapId() == 4) 
/*용뼈*/			|| ((pc.getX() >= 33331 && pc.getX() <= 33339) && (pc.getY() >= 32432 && pc.getY() <= 32440) && pc.getMapId() == 4) 
/*용뼈*/			|| ((pc.getX() >= 33388 && pc.getX() <= 33396) && (pc.getY() >= 32340 && pc.getY() <= 32348) && pc.getMapId() == 4)
/*한국민*/			|| ((pc.getX() >= 33449 && pc.getX() <= 33473) && (pc.getY() >= 32324 && pc.getY() <= 32347) && pc.getMapId() == 4)
/*악어섬*/			|| ((pc.getX() >= 33470 && pc.getX() <= 33530) && (pc.getY() >= 33177 && pc.getY() <= 33231) && pc.getMapId() == 4)
/*샌드웜*/			|| ((pc.getX() >= 32707 && pc.getX() <= 32826) && (pc.getY() >= 33117 && pc.getY() <= 33229) && pc.getMapId() == 4)
/*정무*/			|| (pc.getMapId() == 430) && !pc.isGm()) {
				// \f1여기를 기억할 수가 없습니다.
