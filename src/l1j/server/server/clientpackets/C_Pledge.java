		...
		if (pc.getClanid() > 0) {
            ...
            if (div > 0) {
                ...
                if (page3.size() > 0)
                    ...
                    div = 1;
                if (page1.size() > 0) pc.sendPackets(new S_Pledge(div, 0, page1));
                if (page2.size() > 0) pc.sendPackets(new S_Pledge(div, 1, page2));
                if (page3.size() > 0) pc.sendPackets(new S_Pledge(div, 2, page3));
