            ...
            if (weapon.getItem().getType() == 4) {
            	...
            	attackRange = 1;
				 if ((poly == 15539) || (poly == 15537) || (poly == 15534) || (poly == 15834)
						 ...
						 || (poly == 15531) || (poly == 15833) || (poly == 15832) || (poly == 13743) || (poly == 13745)
						 || (poly == 13735) || (poly == 13737) || (poly == 13715) || (poly == 13717) || (poly == 15115) || (poly == 13721)
						 || (poly == 13723) || (poly == 13725)) {//変身リスト その他（ランカー変身含む）
                    attackRange = 2;
                }
            } else {
                attackRange = 1;
