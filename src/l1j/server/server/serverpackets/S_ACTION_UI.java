...
/****************************************************************************************************/
                ...
                /** ギラン村 - ヘクター **/
                case 70642:
                    craftlist = new int[] { 518, 519, 194, 195, 196, 819, 821, 189, 190, 191, 192, 193, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78 };
                    break;
                /** ギラン村 - バームート **/
                case 70690:
                    craftlist = new int[] { 2783, 2784, 2785, 2786, 2787, 2862, 232, 233, 234, 255, 256, 257, 258, 259, 260, 261, 262, 263, 820, 481, 482, 483, 484, 485, 486, 487, 488 };
                    break;
                /** ギラン村 - アクセサリー - 金属 - **/
                case 7210043:
                    craftlist = new int[] { 2859, 2860, 2763, 2764, 2765, 2766, 2767, 718, 719, 720, 721, 722, 723, 724, 725, 2760, 2761, 2762 };
                    break;
                /** ギラン村 - アクセサリー - ジュエリー - **/
                case 7210044:
                    craftlist = new int[] {
                            ...
                            2775, 2776, 2777, 2778, 2779, 2780, 2781, 2782, 712, 713, 1729, 1730, 305, 309, 313, 1734, 1735, 1736, 1737 };
                    break;
                ...
                /** ギラン村 - アクセサリー - ルームティス - **/
                case 7210052:
                    craftlist = new int[] { 928, 929, 930, 931, 932, 933, 934, 935, 936, 937, 938, 939, 940, 941, 942, 943, 944, 945, 1539, 1540, 1541, 1542, 1543, 1544 };
                    break;
                /** ギラン村 - アクセサリー - スナップファー- **/
                case 7210053:
                    craftlist = new int[] { 946, 947, 948, 949, 950, 951, 952, 953, 954, 955, 956, 957, 958, 959, 960, 961, 962, 963, 964, 965, 966, 967, 968, 969, 970, 971, 972, 973, 974, 975, 976, 977, 978, 979, 980, 981, 982, 983, 984, 985, 986, 987 };
                    break;
                /** ギラン村 - エリクサー - **/
                case 7210054:
...
/****************************************************************************************************/
                ...
                /** ウェルダン村 - ゾウの火ゴーレム **/
                case 5066:
                    craftlist = new int[] { 515, 514, 516, 517, 116, 123, 159, 160, 161, 162, 271, 272, 273, 274, 275, 276, 277, 278, 279, 280, 281, 282, 283, 284, 285, 286, 287, 288, 289, 290, 423, 424, 425 };
                    break;
                /** 忘れられた島 - ラッキー **/
                case 7310086:
...
/****************************************************************************************************/
                /** アデン - ムーブニー **/
                case 7210049:
                    craftlist = new int[] { 823, 824, 825, 826, 827, 828, 829, 830, 831, 832, 833, 834, 835, 836, 837, 838, 839, 840, 841, 842, 843, 844, 845, 846, 847, 848, 849, 850, 851, 852 };
                    break;
/****************************************************************************************************/
                /** 研究室 - ネルウァ **/
                case 7210042:
...
/****************************************************************************************************/
                ...
                //このベルビン
                case 70662:
                    craftlist = new int[] { 2626, 2625, 2624, 2623, 2622, 2619, 2858, 203, 204, 205, 206, 207, 208, 209, 210 };
                    break;
