...
public class L1Rank {
    ...
    public boolean getTotalUpChance() {
        return totalUpChance;
    }

    public void setTotalUpChance(boolean f) {
        totalUpChance = f;
    }

    private boolean totalOvertakingRisk;

    public boolean getTotalOvertakingRisk() {
        return totalOvertakingRisk;
    }

    public void setTotalOvertakingRisk(boolean f) {
        totalOvertakingRisk = f;
    }

    private boolean classUpChance;

    public boolean getClassUpChance() {
        return classUpChance;
    }

    public void setClassUpChance(boolean f) {
        classUpChance = f;
    }

    private boolean classOverTakingRisk;

    public boolean getClassOverTakingRisk() {
        return classOverTakingRisk;
    }

    public void setClassOverTakingRisk(boolean f) {
        classOverTakingRisk = f;
    }
