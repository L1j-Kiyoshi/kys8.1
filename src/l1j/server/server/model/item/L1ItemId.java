...
public class L1ItemId {
    ...
    public static final int DRAGON_DIAMOND1 = 410139; //ドラゴンダイヤモンド交換不可
    ...
    public static final int DRUGA_POKET = 410039; //トゥルがポケット
    public static final int DRAGON_KEY = 410040; //ドラゴンキー
    public static final int DRAGON_PEARL = 410063; //ドラゴンパール
    public static final int DRAGON_PEARL1 = 410137; //ドラゴンパール交換不可
    public static final int EMERALD = 410064; //ドラゴンエメラルド
    public static final int EMERALD1 = 410138; //ドラゴンエメラルド交換不可
    public static final int Inadril_T_ScrollA = 410066; //インナドリル一般
    public static final int Inadril_T_ScrollB = 410067; //インナドリル軸
    public static final int Inadril_T_ScrollC = 410068; //インナドリル呪い
    public static final int Pure_white_Scroll = 410083; //スナップファー強化スクロール
    public static final int Roomtis_Scroll = 410089; //ルームティス強化スクロール
    public static final int ROOMTIS_RED_EARRING = 22229; // ルームティスの赤い光のイヤリング
    public static final int ROOMTIS_BLUE_EARRING = 22230; // ルームティスの青い光のイヤリング
    public static final int ROOMTIS_PURPLE_EARRING = 22231; // ルームティスの紫イヤリング
    public static final int MAGIC_BREATH = 410094; //魔力の息吹
    ...
    public static final int MONSTER_TOENAIL = 30029; // モンスターの爪
    public static final int MONSTER_TOOTH = 30030; // モンスターの歯
    public static final int RUST_HELM = 30031; // さび投球
    public static final int RUST_GLOVE = 30032; // さび手袋
    public static final int RUST_BOOTS = 30033; // さびブーツ

    public static final int INSTRUCTOR_PRESENT_POKET_1 = 30034;    // 教官のギフト袋
    public static final int INSTRUCTOR_PRESENT_POKET_2 = 30035;    // 教官のギフト袋
    public static final int INSTRUCTOR_PRESENT_POKET_3 = 30036;    // 教官のギフト袋
    public static final int INSTRUCTOR_PRESENT_POKET_4 = 30037;    // 教官のギフト袋
    public static final int INSTRUCTOR_PRESENT_POKET_5 = 30038;    // 教官のギフト袋
    public static final int INSTRUCTOR_PRESENT_POKET_6 = 30039;    // 教官のギフト袋

    public static final int EXP_POTION3 = 5000059;
    public static final int EXP_POTION4 = 5000060;

    public static final int BASE_TRAINING_TOKEN = 30040; // 基礎訓練証票
    public static final int PUNITIVE_EXPEDITION_TOKEN = 30041; // 討伐の証
    public static final int VARIETY_DRAGON_BONE = 30042; // バリアントドラゴンの骨

    public static final int PUNITIVE_EXPEDITION_POKET = 30043; // 討伐隊員のポケット
    public static final int PUNITIVE_EXPEDITION_BEAD = 30044; // 輝くビーズ

    public static final int DRAGON_BONE_POKET = 30045; // ドラゴンの骨を収集屋のポケット
    public static final int DRAGON_BONE_BEAD = 30046; // きらめくビーズ

    public static final int IVORYTOWER_SACRED_HELM = 22300;    // 象牙の塔の強固な防具
    ...
    public static final int IVORYTOWER_STRONG_HELM = 22306; //象牙の塔神聖防具
     ...
     * 160120の更新の文章
     **/
//	public static final int Sentence_ARMOR_SCROLL = 3000100; //文章強化石
    public static final int Sentence1 = 900020;//成長の文章
    public static final int Sentence2 = 900021;//回復の文章
}
