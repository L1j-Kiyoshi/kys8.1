 ...
 * このインタフェースを実装するか、関連するメソッドだけオーバーライド（override）してabstractクラスL1GameTimeAdapterを拡張する。
 ...
 * 完了までの時間を必要とする処理や、threadをブロックするメソッドの呼び出しが含まれている処理を行う場合は、内部で新たにthreadを作成し処理を行うべきである。
 */
