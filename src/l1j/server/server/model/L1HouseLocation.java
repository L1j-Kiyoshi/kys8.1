...
public class L1HouseLocation {
    ...
    public static boolean isRegenLoc(L1PcInstance pc, int locx, int locy, short mapid) {
        ...
        if ((ls >= 65374 && ls <= 65408) && (lm >= -734 && lm <= -701) && mapid == 4 && pc.isElf()) {
            ...
            ret = true;
            // シルベリア
        } else if ((ls >= 65649 && ls <= 65679) && (lm >= 47 && lm <= 76) && mapid == 1001 && pc.isBlackwizard()) {
            ret = true;
            // ベヒーモス
    ...
    public static int[] getBasementLoc(int houseId) {
        int[] loc = new int[3];
        if (houseId >= 262145 && houseId <= 262189) {// ギランのアジト1〜45
            loc[0] = 32768;
            loc[1] = 32832;
            loc[2] = houseId - 257077;
        } else if (houseId >= 327681 && houseId <= 327691) { // ハイネのアジト1〜11
            loc[0] = 32766;
            loc[1] = 32827;
            loc[2] = houseId - 322568;
        } else if (houseId >= 458753 && houseId <= 458819) {// アデンのアジト1〜67
            loc[0] = 32768;
            loc[1] = 32759;
