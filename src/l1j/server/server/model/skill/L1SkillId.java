...
public class L1SkillId {
	...
	public static final int NO_DIS = 60001; // ディスネストさ

	public static final int DELAY = 9999; // 広域スターンディレイ
	...
	public static final int weapon_F = 50010;// グンゴムエフェクト
	...
	public static final int DRAGON_SKIN = 181; // ドラゴンスキン

	public static final int BURNING_SLASH = 182;

	public static final int GUARD_BREAK = 183; // ガードブレイク

	public static final int MAGMA_BREATH = 184;

	public static final int SCALES_EARTH_DRAGON = 185;

	public static final int BLOOD_LUST = 186; // ブラッドラスト

	public static final int FOU_SLAYER = 187;

	public static final int FEAR = 188; // ピア
	...
	public static final int MOB_SLOW_18 = 30000; // スロー18番モーション
	public static final int MOB_SLOW_1 = 30001; // スロー1回モーション
	public static final int MOB_CURSEPARALYZ_19 = 30002; //カース19回モーション
	public static final int MOB_COCA = 30003; // コカトリス凍る攻撃
	public static final int MOB_BASILL = 30004; // バシリスクアーリー期ボール
	public static final int MOB_RANGESTUN_19 = 30005; // 範囲スタン19回モーション
	public static final int MOB_RANGESTUN_18 = 30006; // 範囲スタン18回モーション
	public static final int MOB_CURSEPARALYZ_18 = 30007; // カース18回モーション
	public static final int MOB_DISEASE_30 = 30008; // ディジーズ30回モーション
	public static final int MOB_WEAKNESS_1 = 30009; // ウィークネス1回モーション
	public static final int MOB_RANGESTUN_20 = 30010;
	public static final int MOB_DISEASE_1 = 30079; // ディジーズ1回モーション
	public static final int MOB_SHOCKSTUN_30 = 30081; // ショックスタン30回モーション
	public static final int MOB_WINDSHACKLE_1 = 30084; // ウィンドシャックル1回モーション
	public static final int Mob_RANGESTUN_30 = 40007; // ジャドスケール範囲スタン30回モーション<<追加

	public static final int ANTI_DISINTEGRATE = 50001; //アンチディス
	...
	public static final int ANTI_FINAL_BURN = 50005; // アンチディス

	public static final int COMA_A = 50006;
	public static final int COMA_B = 50007;
	public static final int ANTI_METEOR = 50008; // アンチディス
	public static final int LINDBIOR_SPIRIT_EFFECT = 50009;
	public static final int BUFF_CRAY = 50011; // クレイポプ
	/** バフパプリオンサエル追加 **/
	public static final int BUFF_SAEL = 10499;
	public static final int BUFF_GUNTER = 120384;

	public static final int FEATHER_BUFF_A = 22000; // 占いバフ（よい）
	public static final int FEATHER_BUFF_B = 22001; // 占いバフ（良い）
	public static final int FEATHER_BUFF_C = 22002; // 占いバフ（通常）
	public static final int FEATHER_BUFF_D = 22003; // 占いバフ（悪）
	public static final int SetBuff = 90008; // 三バフ

	/** ドラゴンリニューアル関連スキル **/
	public static final int ANTA_MAAN = 7671; // 地竜の魔眼7671
	public static final int FAFU_MAAN = 7672; // 水竜の魔眼7672
	public static final int LIND_MAAN = 7673; // 風竜の魔眼7673
	public static final int VALA_MAAN = 7674; // 火竜の魔眼7674
	public static final int BIRTH_MAAN = 7675; //誕生の魔眼7675
	public static final int SHAPE_MAAN = 7676; // 形状の魔眼7676
	public static final int LIFE_MAAN = 7678; // 生命の魔眼7678

	public static final int ANTA_MESSAGE_1 = 22020; // ヒット[用言1 /キャンセル+麻痺 - >オブモク！ケインドネシア]
	public static final int ANTA_MESSAGE_2 = 22021; // ヒット[用言2 /ブレス+毒/オブモク！ケンロー]
	public static final int ANTA_MESSAGE_3 = 22022; // ヒット[用言3 /ウェンオパンチ+叫ん/オブモク！ティー育て]
	public static final int ANTA_MESSAGE_4 = 22023; // ヒット[用言4 /パンチ+ブレス/オブモク！ケンティ育て]
	public static final int ANTA_MESSAGE_5 = 22024; // ヒット[用言5 /叫び声+ブレス/オブモク！ルーミス]
	public static final int ANTA_MESSAGE_6 = 22025; // ヒット[用言6 /スタン+ジャンプ/オブモク！ミューズ三]
	public static final int ANTA_MESSAGE_7 = 22026; //ヒット[用言7 /スタン+発作/オブモク！ナッツ三]
	public static final int ANTA_MESSAGE_8 = 22027; // ヒット[用言8 /スタン+足+点/オブモク！ティープサム]
	public static final int ANTA_MESSAGE_9 = 22028; // ヒット[用言9 /ウェポンブレス/オブモク！リラのプ]
	public static final int ANTA_MESSAGE_10 = 22029; // ヒット[用言10 /ウェポン+麻痺/オブモク！セイララフ]
	public static final int ANTA_CANCELLATION = 22030; // ヒット[範囲キャンセル/ 6カーン/ 8人]
	public static final int ANTA_SHOCKSTUN = 22031; // ヒット[範囲スタン/ 4カーン]
	public static final int ANTA_WEAPON_BREAK = 22032; // ヒット[範囲ウェポン/ 4カーン]
	public static final int PREDICATEDELAY = 22033; // 用言スキルディレイ

	public static final int PAP_FIVEPEARLBUFF = 22035; // パプ[五色真珠破壊バフ]
	public static final int PAP_MAGICALPEARLBUFF = 22036; // パプ[神秘の五色真珠破壊バフ]
	public static final int PAP_DEATH_PORTION = 22037; // パプ[デスポーションバフ]
	public static final int PAP_DEATH_HELL = 22038; // パプ[デスヒルバフ]
	public static final int PAP_REDUCE_HELL = 22039; // パプ[リデュースヒルバフ]

	public static final int PAP_PREDICATE1 = 22041; // パプ[用言1：リオタ！ピロイや！ 【五色パール/神秘的な五色のパール/トールや召喚]
	public static final int PAP_PREDICATE3 = 22043; // パプ[用言3：リオタ！ラナキュウリので！ [デスポーション]
	public static final int PAP_PREDICATE5 = 22045; // パプ[用言5：リオタ！ネーナウーアヌス！ 【リデュースヒル+頭の攻撃+アイスブレス]
	public static final int PAP_PREDICATE6 = 22046; // パプ[用言6：リオタ！アンテナウェインラク！ [デスヒル+尾の攻撃+アイスブレス]
	public static final int PAP_PREDICATE7 = 22047; // パプ[用言7：リオタ！ラナポンポン！ [キャンセレーション+上がった中2回] [範囲X]
	public static final int PAP_PREDICATE8 = 22048; // パプ[用言8：リオタ！レポポンポン！ [ウェポンブレイク+左手2回] [範囲X]
	public static final int PAP_PREDICATE9 = 22049; // パプ[用言9：リオタ！アンテナ論連邦！ [尾2連打+アイスブレス] [範囲X]
	public static final int PAP_PREDICATE11 = 22051; // パプ[用言11：リオタ！オニーズウェインラク！ [マスキャンセレーション+デスヒル+アイスメテオ+アイスイラプション] [範囲O]
	public static final int PAP_PREDICATE12 = 22052; // パプ[用言12：リオタ！オニーズアックスオンウェインラク！ [マスキャンセレーション+デスヒル+アイスメテオ+発作] [範囲0]

	public static final int ANTA_BUFF = 22015; // アンタラス血痕
	public static final int FAFU_BUFF = 22016; // パプリオン血痕
	public static final int STATUS_DRAGON_PEARL = 22017; // ドラゴンパール
	public static final int EMERALD_YES = 22018; // ドラゴンエメラルド
	public static final int EMERALD_NO = 22019; // ドラゴンエメラルド
	public static final int OMAN_STUN = 22055; //傲慢ボス広域スターン
	public static final int OMAN_CANCELLATION = 22056; // 傲慢ボス広域キャンセル
	public static final int ICE_ERUPTION = 22058; // 極限の武器アイスイラプション
	...
	public static final int RINDVIOR_WIND_SHACKLE = 7001; // ウィンドセクル
	public static final int RINDVIOR_PREDICATE_CANCELLATION = 7002; // リコール召喚
	public static final int RINDVIOR_TORNADO_FORE = 7003; // 竜巻の4つの完全な魔法
	public static final int RINDVIOR_WEAPON = 7004; // ウェポン
	...
	public static final int BLACKELDER = 7037; // [ ライトニング/リッチオーロラ/黒魔法]
	...
	// 砂漠のボス[広域魔法]
	public static final int DESERT_SKILL1 = 7041; // 広域カーズパラライズ
	public static final int DESERT_SKILL2 = 7042; // 広域アースバインド
	public static final int DESERT_SKILL3 = 7043; // 広域マナドレイン
	public static final int DESERT_SKILL4 = 7044; // 広域毒
	public static final int DESERT_SKILL5 = 7045; // カース/ディケイ/ダークネス/ディジーズ/ウィークネス
	public static final int DESERT_SKILL6 = 7046; // 広域ダークネス
	public static final int DESERT_SKILL7 = 7047; // 広域フォグオブスリーピング
	public static final int DESERT_SKILL8 = 7048; // エルジャベトルネード
	public static final int DESERT_SKILL9 = 7049; //エルジャベサモンモンスター
	public static final int DESERT_SKILL10 = 7050; // エルジャベ竜巻出現
	public static final int Sand_worms     = 7055;//サンドワームイラプション
	public static final int Sand_worms1     = 7056;//サンドワームイラプション
	public static final int Sand_worms2     = 7057;//サンドワームイラプション
	public static final int Sand_worms3     = 7058;//サンドワームイラプション
	
	//笑顔ピアバフ
	public static final int Matiz_Buff1 = 7600; //経験値ボーナス10％
