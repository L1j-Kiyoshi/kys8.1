...
//			con = L1DatabaseFactory.getInstance().getConnection();
//			pstm = con
//			.prepareStatement("INSERT INTO character_package_warehouse SET id = ?, account_name = ?, item_id = ?, item_name = ?, count = ?, is_equipped=0, enchantlvl = ?, is_id = ?, durability = ?, charge_count = ?, remaining_time = ?, last_used = ?, attr_enchantlvl = ?, special_enchant = ?");
...
//	}	
//
//	private static Logger _log = Logger.getLogger(L1DwarfForPackageInventory.class
//			.getName());
