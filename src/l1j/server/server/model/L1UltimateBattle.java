...
public class L1UltimateBattle {
    ...
    public void start() {
        switch (getUbId()) {
            case 1:
                L1World.getInstance().broadcastServerMessage("しばらくしてギラン村の無限大戦が開始されます。");
                break;
            case 2:
                L1World.getInstance().broadcastServerMessage("しばらくしてウェルダン村の無限大戦が開始されます。");
                break;
            case 3:
                L1World.getInstance().broadcastServerMessage("しばらくしてグルーディン村の無限大戦が開始されます。");
                break;
            case 4:
                L1World.getInstance().broadcastServerMessage("しばらくして話せる島の無限大戦が開始されます。");
                break;
            case 5:
                L1World.getInstance().broadcastServerMessage("しばらくしてはナイトの村の無限大戦が開始されます。");
                break;
            default:
                break;
        }
